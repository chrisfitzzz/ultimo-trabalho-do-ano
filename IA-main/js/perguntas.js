export const perguntas = [
    {
        enunciado: "Finalmente você está no terceiro ano do ensino médio, e o colégio acabou!! E agora?",
        alternativas: [
            {
                texto: "Isso é assustador!",
                afirmacao: [
                    "No início ficou com medo do que o futuro te reserva.",
                    "Achou assustador pensar na velocidade na qual a vida está avançando."
                ],
                proxima: 1,
            },
            {
